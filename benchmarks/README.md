...
**pnpm-lock.yaml** — pnpm ecosystem (lockfileVersion 9.0)
- **astro** — web framework monorepo (570 workspace packages)
- **nuxt** — Vue meta-framework monorepo
- **vite** — frontend build tool monorepo
